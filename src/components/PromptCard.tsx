    ...
    >
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        <button
          ...
          className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#10a37f] hover:bg-[#0e8f70] text-white rounded-md text-xs font-medium transition-colors"
          title="Try this prompt with ChatGPT"
        >
          {/* ChatGPT Logo */}
          <svg width="16" height="16" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg" strokeWidth="1.5" className="h-4 w-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#6F3CE6] hover:bg-[#5f34c4] text-white rounded-md text-xs font-medium transition-colors"
        ...
        <button
          ...
          className="inline-flex items-center gap-1 px-3 py-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-md text-xs font-medium transition-colors"
